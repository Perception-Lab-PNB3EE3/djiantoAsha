...
The DSM-5 diagnostic criteria requires at least 6 symptoms of inattention and/or of hyperactivity/impulsivity (American Psychiatric Association, 2013), but there is strong evidence that the diagnostic criteria for ADHD is heavily biased toward boys due to girls internalizing behaviour more than boys (Goerz, 2023). This leads to an under diagnosis of ADHD in girls and so they don’t get the treatment that they need or being diagnosed with psychological or learning disabilities. Hong et al. (2014) found that children with subthreshold ADHD experienced similar impairments to full syndrome ADHD. They also suggested that subthreshold ADHD may be a more accurate measure for ADHD in girls. The purpose of the current study is to examine the differences in severity of implicit FER impairment in boys and girls of differing levels of ADHD (TD, subthreshold, and threshold).

## 4. Hypotheses 
If there is a difference in ADHD presentation between boys and girls, there will be a significant interaction effect between ADHD group and gender. 
More specifically, there will be no significant difference between the girls subthreshold and ADHD group in FER impairment (accuracy and reaction time),
and there will be a significant difference between the boys subthreshold and ADHD group in FER impairment (accuracy and reaction time).
...
## 9. Randomization 
Group assignment will not be randomized due to the study being quasi-experimental in nature, but order of trial presentation will be randomized.
This means that the order in which the different emotion types (happy, sad, angry, disgust, fear, surprised) are presented will be completely randomized for each participant.
...
## 13. Sample size 
The target sample size per ADHD symptom level group is 50. We will attempt to recruit 100 subjects per group assuming that not all will complete the total task.
...
## 15. Stopping rule 
Recruitment for data collection will stop being collected once the target sample size is met for each group (100 per group). Because ADHD symptom level groups are expected to be unequal within a population, for the analysis portion of the study, a stratified randomization technique will be used to select 50 participants per group where the selection of participants within each group will be completely randomized. This is to allow for as unbiased analysis as possible by creating equal sample sizes for each group.

# Variables 


## 16. Manipulated variables 
The level of ADHD symptoms is the manipulated variable. The three levels of this categorical variable are typically developing (TD), subthreshold (ST), and ADHD. Participants are grouped based on their responses in the ADHD index of this study. If they agree to 6 or more of the statements, they will be a part of the ADHD group. If they agree to 3–5 statements, they are a part of the subthreshold group. Less than 3 would be a part of the TD group. Results of FER accuracy and reaction time (RT) will be used for a between-group analysis.

Gender (boys, girls) will also be used as a variable to analyze differences in FER impairment between genders within each ADHD symptom level group. The purpose for this variable analysis is to test whether there is an interaction effect of gender and ADHD symptom level (hypothesis testing). Participants will be grouped based on gender which will be included on the ADHD index survey.

The emotion type presented in each scene is another manipulated variable. The 6 categories of this variable are happy, sad, angry, disgust, fear, and surprised. Emotion type will be used for an exploratory, within subject analysis to examine any differences in accuracy and RT of FER for the different emotions. 

## 17. Measured variables 
The measured variables will be reaction time (RT in ms) and accuracy (percent of correctly matched expressions to the scenes). RT will be measured to test the efficiency of different group’s FER strategy.

## 18. Indices 
Group RT and accuracy will be combined into means to allow for analyses between group means.
...
To test the interaction effect hypothesis, I will use a 2x3 factorial ANOVA to see if the effect of ADHD symptom level on FER impairment is dependent on gender. To measure FER impairment, the factorial ANOVA will be done for both measured variables (accuracy and RT). Included in the factorial ANOVA are main effects analyses of each independent variable (ADHD symptom level and gender) on each dependent variable (accuracy and RT). A post-hoc test, Tukey-Kramer test will be used to adjust for multiple comparisons and to see where significant differences exist if applicable. 
...
The results (RT and accuracy) for each emotion type will be analyzed to look for any significant differences in FER based on emotion type. This will include a factorial ANOVA analysis of emotion type and ADHD symptom level being the two factors. There is an expected difference in FER depending on emotion type, so these data will be analyzed in the current study to inform future studies. 

# References

American Psychiatric Association. (2013). Diagnostic and statistical manual of mental disorders: DSM-5. American psychiatric association.

Berggren, S., Engström, A. C., & Bölte, S. (2016). Facial affect recognition in autism, ADHD and typical development. Cognitive Neuropsychiatry, 21(3), 213–227. https://doi.org/10.1080/13546805.2016.1171205
